...
struct VertexPosNormalColor
{
    ...
    constexpr VertexPosNormalColor(const DirectX::XMFLOAT3 &_pos,
...
struct VertexPosNormalTex
{
    ...
    constexpr VertexPosNormalTex(const DirectX::XMFLOAT3 &_pos,
                                 const DirectX::XMFLOAT3 &_normal,
...
struct VertexPosNormalTangentTex
{
    ...
    constexpr VertexPosNormalTangentTex(const DirectX::XMFLOAT3 &_pos,
                                        const DirectX::XMFLOAT3 &_normal,
                                        const DirectX::XMFLOAT4 &_tangent,
                                        const DirectX::XMFLOAT2 &_tex)
