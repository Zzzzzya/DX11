...
class Texture2DBase
{
  public:
    ...
    Texture2DBase(ID3D11Device *device,
    ...
    {
        return m_pTextureSRV.Get();
    }
    ID3D11ShaderResourceView **GetAddressOfShaderResource()
    {
        return m_pTextureSRV.GetAddressOf();
    }
...
class Texture2D : public Texture2DBase
{
  public:
    ...
    {
        return m_pTextureRTV.Get();
    }
    ID3D11RenderTargetView **GetAddressOfRenderTarget()
    {
        return m_pTextureRTV.GetAddressOf();
    }
    ID3D11UnorderedAccessView *GetUnorderedAccess()
    {
        return m_pTextureUAV.Get();
    }
...
{
  public:
    Texture2DMS(ID3D11Device *device,
                uint32_t width,
                uint32_t height,
                DXGI_FORMAT format,
...
{
  public:
    TextureCube(ID3D11Device *device,
                uint32_t width,
                uint32_t height,
                DXGI_FORMAT format,
                uint32_t mipLevels = 1,
...
{
  public:
    Texture2DArray(ID3D11Device *device,
                   uint32_t width,
                   uint32_t height,
                   DXGI_FORMAT format,
                   uint32_t arraySize,
...
{
  public:
    Texture2DMSArray(ID3D11Device *device,
                     uint32_t width,
                     uint32_t height,
                     DXGI_FORMAT format,
                     uint32_t arraySize,
...
{
  public:
    Depth2DArray(ID3D11Device *device,
                 uint32_t width,
                 uint32_t height,
                 uint32_t arraySize,
                 DepthStencilBitsFlag depthStencilBitsFlag = DepthStencilBitsFlag::Depth_24Bits_Stencil_8Bits,
...
{
  public:
    Depth2DMSArray(ID3D11Device *device,
                   uint32_t width,
                   uint32_t height,
                   uint32_t arraySize,
                   const DXGI_SAMPLE_DESC &sampleDesc,
